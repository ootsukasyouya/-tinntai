...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { address: @apartment.address, age: @apartment.age, name: @apartment.name, remarks: @apartment.remarks, rent: @apartment.rent } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { address: @apartment.address, age: @apartment.age, name: @apartment.name, remarks: @apartment.remarks, rent: @apartment.rent } }
